  ...
  return (
    <div className='flex flex-col gap-4 '>
      <div className='flex items-center justify-center gap-2'>
            <p className='text-xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-slate-400'>{index}</p>
...
export default function Genorator(props) {
  ...
  return (
   ...
   return (
    <button onClick={() => {
      setMuscles([])
      setPoison(type)
    }} className={'bg-slate-950 px-4 border py-3 rounded-lg duration-200 hover:border-blue-600' + (type === poison ? ' border-blue-400':'border-blue-600 ')} 
    key={typeIndex}>
   ...
   <div className='flex flex-col bg-slate-950 border border-solid border-blue-400 rounded-lg'>
    <button onClick={toggleModal} className='relative p-3 flex item-center justify-center'>
   ...
   return (
    <button onClick={() => {
      setGoal(scheme)
    }} className={'bg-slate-950 px-4 border py-3 rounded-lg duration-200 hover:border-blue-600' + (scheme === goal ? ' border-blue-400':'border-blue-600 ')} 
    key={schemeIndex}>
